...
\subsection{\acs{lstm} neural networks}
...
In recent years, there also have been approaches for the problems of seizure detection and prediction which make use of graph deep learning models.
